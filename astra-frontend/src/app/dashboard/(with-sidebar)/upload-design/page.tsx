...
export default function UploadDesign() {
  ...
  const isButtonEnabled = uploaded && description.length >= 10;
  ...
  return (
    <div className='w-full min-h-screen flex justify-center items-center relative bg-[#F9F9F9] pt-12 pb-10 px-5 md:px-[60px] h-auto'>
      <div className='w-full max-w-2xl bg-white rounded-2xl shadow-sm border border-[#E0E0E0] p-6 py-8 md:px-[65px]'>
        ...
        {file && (
          <div className='relative border-2 border-gray-100 w-full p-4 rounded-lg mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between overflow-hidden'>
            <div className='flex items-start flex-1'>
              ...
              <div className='flex-1'>
                <p className='font-medium w-[40%] md:max-w-[78%] truncate text-ellipsis overflow-hidden whitespace-nowrap'>
                  {file.name}
                </p>
                ...
                <div className='flex items-center gap-2 flex-wrap md:flex-nowrap w-[90%] md:w-full'>
                  <Progress
                    value={progress}
                    className='mt-2 w-[60%] md:w-full'
                  />
                  <p className='text-sm text-gray-500 mt-1'>{progress}%</p>
                </div>
              </div>
            </div>
            <div className='mt-3 sm:mt-0 sm:absolute sm:top-2 sm:right-3 flex items-center justify-between gap-2'>
              {uploaded && (
                <Button
                  variant='link'
                  className='p-0 text-sm sm:mr-1'
