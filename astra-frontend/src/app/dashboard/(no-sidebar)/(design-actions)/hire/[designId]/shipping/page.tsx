    ...
    <>
      ...
      <div className='w-full md:max-w-xl border border-[#E0E0E0] mt-12 md:mt-0 bg-white rounded-2xl shadow-sm p-6 md:p-8 flex flex-col items-center'>
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          {/* If you still want a visual trigger button, use DialogTrigger.
              Here we keep the Dialog controlled programmatically so trigger is optional */}
          <DialogContent className='sm:max-w-lg'>
            <DialogHeader>
              ...
              <DialogDescription>
                Your hiring request has been posted to the marketplace. Makers
                will be able to see and apply for this job.
              </DialogDescription>
            </DialogHeader>
