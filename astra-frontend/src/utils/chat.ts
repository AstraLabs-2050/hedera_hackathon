...
export function normalizeMessage(
    ...
    if (kind === "payment" || kind === "system.accepted") {
        ...
        if (opts?.makerId && raw.senderId && raw.senderId === opts.makerId) sender = "maker";
        else if (opts?.creatorId && raw.senderId && raw.senderId === opts.creatorId) sender = "creator";
        else if (raw.sender === "system" || raw.from === "system") sender = "system";
        else sender = "creator"; // safe default
    }
