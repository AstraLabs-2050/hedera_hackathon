          ...
          {(design.publishedStatus === "draft" ||
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  <AlertDialogTitle>
                    Publish {transformedDesign.title} to Marketplace?
                  </AlertDialogTitle>
                  <AlertDialogDescription>
      ...
      return (
        <AlertDialog>
          <AlertDialogTrigger asChild>
            <Button
              variant='outline'
              className='rounded-full text-sm py-2 bg-transparent text-destructive border border-destructive hover:text-white hover:bg-red-600'>
              Unpublish Design
            </Button>
          </AlertDialogTrigger>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>
                Unpublish {transformedDesign.title}?
              </AlertDialogTitle>
              <AlertDialogDescription>
                This design will no longer be available in the marketplace and
                won&apos;t be visible to buyers. Are you sure you want to
                continue?
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
      ...
      <div className='flex flex-col gap-2 w-full md:w-fit'>
        ...
        <div className='flex md:flex-col gap-4 md:gap-2 text-sm text-gray-500'>
          <span className='flex items-center gap-1'>
            <Image src='/usdc.png' alt='usdc logo' width={16} height={16} />{" "}
