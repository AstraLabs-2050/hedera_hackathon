          ...
          <div className='text-center max-w-2xl space-y-8'>
            ...
            <div className='space-y-4'>
              <button
                onClick={handleNew}
                disabled={starting}
                className={`group relative px-8 py-2 bg-black text-white rounded-2xl font-semibold text-sm transition-all duration-300 hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-4 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none ${
                  starting ? "animate-pulse" : ""
                }`}>
                {starting ? (
                  <div className='flex items-center gap-3'>
                    <div className='w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin'></div>
                    <span>Creating Your Design Studio...</span>
                  </div>
                ) : (
                  <div className='flex items-center gap-3'>
              ...
              <div className='flex items-center justify-center  '>
                <div className='flex items-center gap-4 bg-white px-3 py-2 border border-gray-200 rounded-xl hover:border-blue-300 hover:shadow-md transition-all duration-200 focus:outline-none'>
                  <p className='text-sm text-gray-500'>
                    Already have a design?
                  </p>
                  <Button
                    onClick={() => router.push("/dashboard/upload-design")}
                    size='lg'>
                    Upload here
                  </Button>
                </div>
