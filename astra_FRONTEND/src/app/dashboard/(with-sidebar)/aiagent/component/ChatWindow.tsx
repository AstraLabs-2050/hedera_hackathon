...
import DirectMintToNFT from "./DirectmintToNFT";
import GeneratingIndicator from "./GeneratingIndicator";
import { CircleCheck } from "lucide-react";
import Link from "next/link";

// Extend ChatMessage to include optional attachments for local use
...
const ChatWindow: React.FC<Props> = ({ chatId }) => {
  ...
  const refreshChatSidebar = useCallback(() => {
    // Call the global refresh function that we set up in ChatSidebar
    if (
      window &&
  ...
  const handleError = useCallback(
    (err, context: string) => {
      ...
      if (retryCount < MAX_RETRY_ATTEMPTS) {
        ...
        // Optionally, you could trigger a retry here
      }
    },
    [retryCount]
  );
  ...
  useEffect(() => {
    ...
    const setupChannel = async () => {
      ...
      try {
        ...
        // console.log("Raw channel messages:", channel.state.messages);
        // console.log("Processed stream messages:", streamMessages);
        ...
        const handleNewMessage = (event) => {
          ...
          // console.log("📩 New message from AI:", m);
            ...
            if (
              ...
              if (userSelection) {
                ...
                if (lastAiWithImages) {
                  ...
                  // console.log("No previous message with variations found", {
  ...
  return (
    <div className='flex-1 flex flex-col w-full bg-gray-50 text-black md:px-[24px] pt-3 h-full font-[ClashGrotesk-regular] relative'>
      ...
      {selectedVariation && !minted ? (
        <div className='pb-3'>
          <DirectMintToNFT
            ...
            contractAddress='0xE6350728D29474d797185D0202326e2Bce952CA4'
            isProd={false}
        ...
        <div className='text-left mb-2 md:ml-16 bg-white w-fit border border-gray-200 rounded-2xl px-3 py-[5px] shadow-sm'>
          <div className='flex items-start gap-2'>
            ...
            <div className='text-sm font-medium'>
              <p className='text-green-600'>Design Published Successfully!</p>
