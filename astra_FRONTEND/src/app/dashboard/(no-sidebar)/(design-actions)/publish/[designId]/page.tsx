...
export default function PublishPage() {
  ...
  useEffect(() => {
    setMounted(true);
    if (!isEditMode) {
      const savedData = getPublishData("step1");
      if (savedData) {
  ...
  const displayQuantity = isEditMode
    ? quantityValue || design?.quantity || "0"
    : quantityValue || "0";
