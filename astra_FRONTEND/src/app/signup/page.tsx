...
//   // ✅ Validation schema
//   const validationSchema = Yup.object({
//     fullName: Yup.string().required("Full name is required"), // ✅ added
//     email: Yup.string().email("Invalid email address").required("Email is required"),
//     password: Yup.string()
...
//         if (!response?.status) {
//           return Notification.error(response?.message || "Registration failed. Try again.");
//         }

//         if (response?.data?.token) {
//           setCookie(null, TOKEN_NAME, response.data.token);
//         }
//         if (response?.data?.brandId) {
//           setCookie(null, BRAND_ID, response.data.brandId);
//         }
//         if (response?.data?.userId) {
//           setCookie(null, USER_ID, response.data.userId);
//         }
...
//                 <p className="text-[12px] text-red-500 mt-1">{formik.errors.fullName}</p>
//               )}
//             </div>
