...
type Props = { 
    align?: 'left' | 'right';
    msg: SystemAcceptedMsg
 };

export default function SystemAccepted({ msg, align = 'left', }: Props) {
    // const { projectTitle, description, timeline, amount } = msg.data;
    const app = msg.data.applicationData || msg.data;
const { projectTitle, description, timeline, amount } = app;
